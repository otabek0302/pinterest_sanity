                ...
                <div className="w-[268px] mx-auto">
                    <form onSubmit={handleSubmit}>
                        <div className="mb-2 flex flex-col">
                            <label htmlFor="email" className="ml-2.5 mb-1.5 text-sm text-copy-light font-normal leading-tight cursor-pointer">Email</label>
                            <input name="email" onChange={(e) => setEmail(e.target.value)} value={email} type="email" placeholder="Email address" className="py-3 px-4 rounded-2xl border-2 border-border hover:border-border-dark focus:outline-6 focus:outline-blue-300 text-base text-copy-lighter font-normal" />
                        </div>
                        <div className="mb-2 flex flex-col">
                            <label htmlFor="password" className="ml-2.5 mb-1.5 text-sm text-copy-light font-normal leading-tight cursor-pointer">Password</label>
                            <input name="password" onChange={(e) => setPassword(e.target.value)} value={password} type="password" placeholder="Password" className="py-3 px-4 rounded-2xl border-2 border-border hover:border-border-dark focus:outline-6 focus:outline-blue-300 text-base text-copy-lighter font-normal" />
                            {
                                auth === "login" && (
                                    <Link href="/forget-password" className="my-2 px-1.5">
                                        <span className="text-sm text-copy font-semibold">Forgot your password ?</span>
                                    </Link>
                                )
                            }
                        </div>
                        {
                            auth === "singup" && (
                                <div className="mb-2 flex flex-col">
                                    <label htmlFor="birthday" className="ml-2.5 mb-1.5 text-sm text-copy-light font-normal leading-tight cursor-pointer">Birthday</label>
                                    <input name="birthday" onChange={(e) => setBirthday(e.target.value)} value={birthday} type="date" placeholder="dd/mm/yy" className="py-3 px-4 rounded-2xl border-2 border-border hover:border-border-dark focus:outline-6 focus:outline-blue-300 text-base text-copy-lighter font-normal" />
                                </div>
                            )
                        }
