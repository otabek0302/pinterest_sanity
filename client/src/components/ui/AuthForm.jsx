      ...
      <div className="px-2.5 pt-5 pb-6">
        ...
        <div className="w-[268px] mx-auto">
          <form onSubmit={handleSubmit}>
            ...
            <p className="text-center text-error text-sm my-2.5">{error}</p>
            <p className="text-center text-success text-sm my-2.5">{success}</p>
          </form>
          ...
          <div className="mt-2.5">
            {auth === "login" && (
              <button
                type="button"
                className="relative w-full py-2 px-5 mb-2.5 bg-[#1877f2] hover:bg-[#1877f9] text-base text-white font-normal text-center rounded-[20px] cursor-pointer"
              >
